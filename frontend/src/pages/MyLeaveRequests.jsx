...
const MyLeaveRequests = () => {
  ...
  // Use mock data for leave requests
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">{statusCounts.Approved || 0}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">{statusCounts.Pending || 0}</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">{statusCounts.Rejected || 0}</dd>
                </dl>
              </div>
            </div>
          </div>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="mt-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm text-gray-600">
                            ...
                            <div>
                              <span className="font-medium">Days:</span> {request.days} day{request.days !== 1 ? 's' : ''}
                            </div>
                            <div>
                          ...
                          {request.comments && (
                            <div className="mt-3">
                              ...
                              <p className="mt-1 text-gray-600">{request.comments}</p>
                            </div>
                          )}
                        </div>
                      </div>
